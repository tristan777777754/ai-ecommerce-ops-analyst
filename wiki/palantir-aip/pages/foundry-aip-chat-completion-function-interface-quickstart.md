...
* Familiarize yourself with [how to set up Data Connection sources and network policies](https://www.palantir.com/docs/foundry/data-connection/set-up-source/) to understand how to connect your specific LLM endpoint to Foundry.
...
You can write your chat completion implementation in TypeScript. To do so, you will need to [create a new TypeScript functions repository](https://www.palantir.com/docs/foundry/functions/getting-started/).
...
This tutorial assumes a basic understanding of writing TypeScript functions in Foundry. Review the [getting started](https://www.palantir.com/docs/foundry/functions/getting-started/) guide for an introduction to TypeScript functions in Foundry.
:::
...
2. In the **Resource imports** panel, search for the `OpenAI` source that contains the `CreateChatCompletion` webhook and import it into your TypeScript repository. [Learn more about how to import resources into Code Repositories.](https://www.palantir.com/docs/foundry/functions/resource-imports-sidebar/)
